...
public class ToastUtils {
     ...
     * @param message
     */
    public static void showToastCentre(Context context, String message) {
        if (sToast == null) {
    ...
    public static void showToastBottom(Context context, String message) {
        ...
        sToast.setGravity(Gravity.BOTTOM, 0, 170);
        sToast.show();
        sToast = null;
    }
     ...
     * @param resId   资源id
     */
    public static void showToastCentre(Context context, int resId) {
        if (sToast == null) {
            sToast = Toast.makeText(context, context.getResources().getString(resId),
                    Toast.LENGTH_SHORT);
        }
        sToast.setGravity(Gravity.CENTER, 0, 0);
        sToast.show();
